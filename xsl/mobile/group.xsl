          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="heading{position()}">
              <h4 class="panel-title">
                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse{position()}" aria-expanded="false" aria-controls="collapse{position()}">
            ...
            <div id="collapse{position()}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading{position()}">
              <div class="panel-body">
                <!-- number -->
                  <p class="number">
                    <a class="btn btn-primary" href="{$relpath}mobile/courses/course.html?catnum={@cat_num}" title="{title}">
