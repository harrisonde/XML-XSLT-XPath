<?xml version="1.0" encoding="utf-8"?>
	...
	<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns="http://www.w3.org/1999/xhtml">  
		...
		<xsl:template match="document-node()">    		
			...
			<html xmlns="http://www.w3.org/1999/xhtml">      
				...
				<head>  
					...
					-->
	        		<meta charset="utf-8"/>
	        		<meta name=">Harvard University, Faculity of Arts &amp; Sciences" content="Courses"/>
	      			<!--
		...
		<xsl:template name="branding">
  				...
  				<div class="container-fluid">
	    			...
	    			<div class="navbar-header">
				    	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
	      				...
	      				<a href="{$relpath}mobile/index/home.html">	
	      					<img class="logo pull-left" alt="logo" height="26" width="31" src="{$relpath}images/harvard_shield.png"/>
	    				</a>	
	    			</div>
	    			...
	    			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav">
				      	 <li>
				         	<a href="{$relpath}mobile/search/course.html">Courses</a>
				         </li>		
						<li>        
			         		<a href="{$relpath}mobile/departments/department.html">Departments</a>
			         	</li>	
					    <li>
			...
			<div class="search col-10-xs">
				<form action="{$relpath}mobile/search/course.html" method="GET" role="search">
	    		<!-- hidden input fields -->
			        ...
			        <div class="form-group">
			         	<input name="ftxt" type="text" class="form-control pull-left" placeholder="Search Course Catalog"/>
		...
		<xsl:template name="page_title">
			<h5 class="logo-text pull-left">Harvard University, Faculity of Arts &amp; Sciences Course Catalog</h5>  
	  	</xsl:template>
		...
		<xsl:template name="footer">
			<hr/>
			<img class="logo pull-left" height="26" width="31" alt="logo" src="{$relpath}images/harvard_shield.png"/>
		...
		<xsl:template name="site_css">
			<!-- Import Bootstrap -->
       		 <link rel="stylesheet" href="{$relpath}css/mobile.css" type="text/css" media="screen, projection" />
		</xsl:template>  
